...
public class ClientPacketHandler {
    ...
    public static void handleFlowerGenUpdate(S2CPacketFlowerGenUpdate msg) {
        ...
        ((IFlowerGeneration) flowerGen).naturesaura_plus$flowerTileAuraGeneratorSetVitality(msg.vitality());
        ((IFlowerGeneration) flowerGen).naturesaura_plus$flowerTileAuraGeneratorWriteFlower(msg.flower());
    }
}
