...
public class GameplayConfig {
    ...
    // Tools
    public static final ForgeConfigSpec.IntValue BREAK_PREVENTION_APPLY_COST;
    public static final ForgeConfigSpec.IntValue LOOT_FINDER_AURA_COST;
    public static final ForgeConfigSpec.IntValue LOOT_FINDER_RANGE;
    public static final ForgeConfigSpec.IntValue LOOT_FINDER_USE_COOLDOWN;
    public static final ForgeConfigSpec.IntValue LOOT_FINDER_LIGHT_LIFE;
    public static final ForgeConfigSpec.IntValue PET_RECALL_RANGE;
    public static final ForgeConfigSpec.IntValue SASH_AURA_CAPACITY;
    public static final ForgeConfigSpec.IntValue SASH_MANA_CAPACITY;

    // Furnace Booster
    public static final ForgeConfigSpec.IntValue FURNACE_BOOSTER_AURA_COST;
    public static final ForgeConfigSpec.BooleanValue CHECK_TAG_FOR_FURNACE_BOOST;
    public static final ForgeConfigSpec.IntValue FURNACE_BOOSTER_CHANCE;

    // Bountiful Core
    public static final ForgeConfigSpec.BooleanValue CUBICAL_ORE_SPAWN;
    public static final ForgeConfigSpec.IntValue MIN_AURA_FOR_ORE_SPAWN;
    public static final ForgeConfigSpec.IntValue MAX_ITERATION_FOR_ORE_SPAWN;
    public static final ForgeConfigSpec.DoubleValue ORE_SPAWN_ITER_SCALE;
    public static final ForgeConfigSpec.DoubleValue ORE_SPAWN_RANGE_SCALE;
    public static final ForgeConfigSpec.IntValue MIN_ORE_SPAWN_RANGE;
    public static final ForgeConfigSpec.IntValue MAX_ORE_SPAWN_RANGE;
    public static final ForgeConfigSpec.IntValue MAX_ORE_PLACE_ATTEMPTS;
    ...
    static {
        ...
        LOOT_FINDER_USE_COOLDOWN = BUILDER
        ...
        LOOT_FINDER_LIGHT_LIFE = BUILDER
        ...
        CHECK_TAG_FOR_FURNACE_BOOST = BUILDER
        ...
        FURNACE_BOOSTER_CHANCE = BUILDER
                .comment("The aura cost per recipe for the furnace booster block. (Default: 45)")
                .defineInRange("furnaceBoosterChance", 45, 0, 100);
        BUILDER.pop();


        BUILDER.comment("Powder of the Bountiful Core").push("BountifulCore");
        CUBICAL_ORE_SPAWN = BUILDER
        ...
        MIN_AURA_FOR_ORE_SPAWN = BUILDER
        ...
        MAX_ITERATION_FOR_ORE_SPAWN = BUILDER
        ...
        MAX_ORE_PLACE_ATTEMPTS = BUILDER
