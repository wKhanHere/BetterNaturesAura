...
public class ModBlocks {
    ...
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, NaturesAuraPlus.MODID);

    public static final RegistryObject<Block> AURIC_OVEN_BRICK = BLOCKS.register("auric_oven_brick",
            () -> new OvenPartBlock(BlockBehaviour.Properties.copy(Blocks.NETHER_BRICKS).mapColor(MapColor.COLOR_GRAY))); //work out sounds
