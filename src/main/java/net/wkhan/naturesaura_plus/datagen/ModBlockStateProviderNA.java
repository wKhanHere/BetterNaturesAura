...
public class ModBlockStateProviderNA extends BlockStateProvider {
    public ModBlockStateProviderNA(PackOutput output, String MODID, ExistingFileHelper exFileHelper) {
